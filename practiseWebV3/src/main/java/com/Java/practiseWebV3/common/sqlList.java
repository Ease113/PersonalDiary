...
public class sqlList {
	...
	public static String SQLNB015 = "SELECT A.REG_ID, A.TITLE, A.ARTICLE, A.AUTHOR, A.TAG, A.CATEGORY, A.SERIES, A.REG_SYS_TIME, A.UPD_SYS_TIME FROM ARTICLE_INFO AS A, USER_INFO AS U WHERE A.AUTHOR = U.USER_NAME AND A.REG_ID = {0} AND A.AUTHOR = '{1}' AND A.DEL_FLG = 0 AND U.DEL_FLG = 0 ";
